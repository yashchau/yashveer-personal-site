...
export default function SiteLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-dvh bg-[var(--bg)]">
        ...
        <nav className="glass mx-auto flex w-full max-w-7xl items-center justify-between rounded-full px-3 py-2 md:px-4">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-1 md:hidden">
              <Link href="/projects" className="secondary-button px-3 py-1.5 text-xs">
                Projects
              </Link>
              <Link href="/ventures" className="secondary-button px-3 py-1.5 text-xs">
                Ventures
              </Link>
              <Link href="/blog" className="secondary-button px-3 py-1.5 text-xs">
                Blog
              </Link>
              <Link href="/resume" className="secondary-button px-3 py-1.5 text-xs">
                Résumé
              </Link>
            </div>
            <ThemeToggle />
      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-14 pt-10 sm:px-6 md:pt-14 lg:px-8">{children}</main>
      <footer className="mx-auto w-full max-w-7xl px-4 pb-10 sm:px-6 lg:px-8">
        <div className="glass flex flex-col justify-between gap-5 rounded-[28px] p-6 text-sm md:flex-row md:items-center md:p-8">
          <div className="space-y-1">
            <div className="font-semibold text-[var(--text)]">© {new Date().getFullYear()} Yashveer Chauhan</div>
          ...
          <div className="flex flex-wrap gap-3 text-[var(--muted)]">
            ...
            <a href="mailto:hello@yashveer.dev" className="primary-button px-4 py-2 text-sm">
              Contact
            </a>
          </div>
        </div>
